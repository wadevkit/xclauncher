...
.method public constructor <init>(Lcom/android/wm/shell/common/TransactionPool;Lcom/android/wm/shell/transition/Transitions;Ljava/lang/Runnable;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/wm/shell/splitscreen/w;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;)V
...
.method public static synthetic a(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/window/WindowContainerTransaction;Landroid/window/WindowContainerTransactionCallback;)V
    .locals 0
...
.method public static synthetic d(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic g(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FLandroid/animation/ValueAnimator;)V
    .locals 0
...
.method private synthetic lambda$new$0(Landroid/window/WindowContainerTransaction;Landroid/window/WindowContainerTransactionCallback;)V
    ...
    const-string p2, "finish transactions not supported yet."
...
.method private static synthetic lambda$startExampleAnimation$1(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FFLandroid/animation/ValueAnimator;)V
    ...
    invoke-static {p0, p1, p3}, Lcom/android/systemui/shared/recents/model/a;->q(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;F)V

    invoke-static {p0}, Lcom/android/systemui/shared/recents/model/a;->o(Landroid/view/SurfaceControl$Transaction;)V
...
.method private synthetic lambda$startExampleAnimation$3(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FLandroid/animation/ValueAnimator;)V
    ...
    new-instance p2, Lcom/android/wm/shell/splitscreen/t;

    const/4 p3, 0x1

    invoke-direct {p2, p0, p4, p3}, Lcom/android/wm/shell/splitscreen/t;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/animation/ValueAnimator;I)V
...
.method private synthetic lambda$startExampleResizeAnimation$6(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p2, p0, p4, v0}, Lcom/android/wm/shell/splitscreen/t;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/animation/ValueAnimator;I)V
...
.method private playInternalAnimation(Landroid/os/IBinder;Landroid/window/TransitionInfo;Landroid/view/SurfaceControl$Transaction;Landroid/window/WindowContainerToken;Landroid/window/WindowContainerToken;)V
    ...
    invoke-static {p3, v7}, Lcom/android/systemui/shared/recents/model/a;->p(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V

    invoke-virtual {p2}, Landroid/window/TransitionInfo;->getRootLeash()Landroid/view/SurfaceControl;

    move-result-object v7

    invoke-static {p3, v3, v7}, Lcom/android/systemui/shared/recents/model/a;->s(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;)V
    ...
    invoke-static {p3, v3, v7}, Lcom/android/systemui/shared/recents/model/a;->r(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;I)V
    ...
    invoke-static {v7, v3, v5}, Lcom/android/systemui/shared/recents/model/a;->s(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;)V
    ...
    invoke-static {p3, v3}, Lcom/android/wm/shell/common/magnetictarget/a;->y(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
...
.method private startExampleAnimation(Landroid/view/SurfaceControl;Z)V
    ...
    new-instance v1, Lcom/android/wm/shell/splitscreen/u;

    invoke-direct {v1, v3, p1, v0, v5}, Lcom/android/wm/shell/splitscreen/u;-><init>(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FF)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/wm/shell/splitscreen/v;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;FLandroid/animation/ValueAnimator;)V
    ...
    invoke-virtual {p1}, Lcom/android/wm/shell/transition/Transitions;->getAnimExecutor()Lcom/android/wm/shell/common/ShellExecutor;

    move-result-object p1

    new-instance v0, Lcom/android/wm/shell/legacysplitscreen/u;

    invoke-direct {v0, p2, v7}, Lcom/android/wm/shell/legacysplitscreen/u;-><init>(Landroid/animation/ValueAnimator;I)V
...
.method private startExampleResizeAnimation(Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-direct {v1, v3, p1, p2, p3}, Lcom/android/wm/shell/splitscreen/x;-><init>(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-instance p2, Lcom/android/wm/shell/splitscreen/y;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/wm/shell/splitscreen/y;-><init>(Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/animation/ValueAnimator;)V
    ...
    new-instance p2, Lcom/android/wm/shell/legacysplitscreen/u;

    const/4 p3, 0x1

    invoke-direct {p2, v0, p3}, Lcom/android/wm/shell/legacysplitscreen/u;-><init>(Landroid/animation/ValueAnimator;I)V
...
.method public startEnterTransition(ILandroid/window/WindowContainerTransaction;Landroid/window/RemoteTransition;Lcom/android/wm/shell/transition/Transitions$TransitionHandler;)Landroid/os/IBinder;
    ...
    iget-object p2, p0, Lcom/android/wm/shell/splitscreen/SplitScreenTransitions;->mRemoteHandler:Lcom/android/wm/shell/transition/OneShotRemoteHandler;
