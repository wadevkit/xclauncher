...
.field public final e:[Lio/reactivex/rxjava3/core/MaybeSource;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.method public constructor <init>(Lorg/reactivestreams/Subscriber;)V
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->e:[Lio/reactivex/rxjava3/core/MaybeSource;
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->f:Lio/reactivex/rxjava3/internal/util/AtomicThrowable;
...
.method public final a()V
    ...
    :cond_1
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->d:Lio/reactivex/rxjava3/internal/disposables/SequentialDisposable;
    ...
    iget-object v5, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->a:Lorg/reactivestreams/Subscriber;

    const/4 v6, 0x1

    if-eq v2, v4, :cond_4

    iget-wide v7, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->h:J

    iget-object v4, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-wide v7, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->h:J
    ...
    iget v1, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->g:I

    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->e:[Lio/reactivex/rxjava3/core/MaybeSource;

    array-length v3, v2

    if-ne v1, v3, :cond_5

    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->f:Lio/reactivex/rxjava3/internal/util/AtomicThrowable;

    invoke-virtual {v0, v5}, Lio/reactivex/rxjava3/internal/util/AtomicThrowable;->f(Lorg/reactivestreams/Subscriber;)V
    ...
    iput v3, p0, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->g:I
...
.method public final onComplete()V
    ...
    invoke-virtual {p0}, Lio/reactivex/rxjava3/internal/operators/maybe/MaybeConcatArrayDelayError$ConcatMaybeObserver;->a()V
