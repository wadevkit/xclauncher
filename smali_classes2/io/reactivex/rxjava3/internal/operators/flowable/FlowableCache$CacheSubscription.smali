...
.method public final request(J)V
    ...
    :cond_0
    iget-wide v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->f:J

    iget p2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->e:I

    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->d:Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$Node;

    iget-object v3, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->c:Ljava/util/concurrent/atomic/AtomicLong;

    iget-object v4, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->a:Lorg/reactivestreams/Subscriber;
    ...
    :cond_1
    :goto_0
    iget-boolean v7, p1, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache;->g:Z

    iget-wide v8, p1, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache;->c:J
    ...
    iput-object v10, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->d:Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$Node;

    iget-object p1, p1, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache;->f:Ljava/lang/Throwable;
    ...
    iget-object p2, v2, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$Node;->b:Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$Node;
    ...
    :cond_6
    iget-object v7, v2, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$Node;->a:[Ljava/lang/Object;
    ...
    :cond_7
    iput-wide v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->f:J

    iput p2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->e:I

    iput-object v2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$CacheSubscription;->d:Lio/reactivex/rxjava3/internal/operators/flowable/FlowableCache$Node;
