...
.field public static final i:[Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lio/reactivex/processors/BehaviorProcessor;->h:[Ljava/lang/Object;

    new-array v1, v0, [Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;

    sput-object v1, Lio/reactivex/processors/BehaviorProcessor;->i:[Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;

    new-array v0, v0, [Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;

    sput-object v0, Lio/reactivex/processors/BehaviorProcessor;->j:[Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lio/reactivex/processors/BehaviorProcessor;->c:Ljava/util/concurrent/locks/Lock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;->writeLock()Ljava/util/concurrent/locks/Lock;

    move-result-object v0

    iput-object v0, p0, Lio/reactivex/processors/BehaviorProcessor;->d:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v1, Lio/reactivex/processors/BehaviorProcessor;->i:[Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;
...
.method public final i(Lorg/reactivestreams/Subscriber;)V
    ...
    sget-object v3, Lio/reactivex/processors/BehaviorProcessor;->j:[Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;
    ...
    new-array v6, v6, [Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/BehaviorProcessor;->l(Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;)V
    ...
    :cond_6
    iget-boolean p1, v0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->c:Z
    ...
    :cond_7
    iget-object p1, v0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->b:Lio/reactivex/processors/BehaviorProcessor;

    iget-object v1, p1, Lio/reactivex/processors/BehaviorProcessor;->c:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    iget-wide v2, p1, Lio/reactivex/processors/BehaviorProcessor;->g:J

    iput-wide v2, v0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->h:J

    iget-object p1, p1, Lio/reactivex/processors/BehaviorProcessor;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :goto_2
    iput-boolean v1, v0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->d:Z

    iput-boolean v5, v0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->c:Z
    ...
    :try_start_1
    iget-object p1, v0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->e:Lio/reactivex/internal/util/AppendOnlyLinkedArrayList;

    if-nez p1, :cond_b

    iput-boolean v4, v0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->d:Z
    ...
    iput-object v1, v0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->e:Lio/reactivex/internal/util/AppendOnlyLinkedArrayList;
...
.method public final l(Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;)V
    ...
    sget-object v2, Lio/reactivex/processors/BehaviorProcessor;->i:[Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;
...
.method public final onComplete()V
    ...
    sget-object v4, Lio/reactivex/processors/BehaviorProcessor;->j:[Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;
    ...
    iget-object v1, p0, Lio/reactivex/processors/BehaviorProcessor;->d:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    iget-wide v4, p0, Lio/reactivex/processors/BehaviorProcessor;->g:J

    const-wide/16 v6, 0x1

    add-long/2addr v4, v6

    iput-wide v4, p0, Lio/reactivex/processors/BehaviorProcessor;->g:J

    iget-object v4, p0, Lio/reactivex/processors/BehaviorProcessor;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-wide v5, p0, Lio/reactivex/processors/BehaviorProcessor;->g:J
...
.method public final onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1, v4, v5, p1}, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->a(JLjava/lang/Object;)V
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    iget-wide v1, p0, Lio/reactivex/processors/BehaviorProcessor;->g:J

    const-wide/16 v3, 0x1

    add-long/2addr v1, v3

    iput-wide v1, p0, Lio/reactivex/processors/BehaviorProcessor;->g:J
