...
.method public final b(Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    :cond_0
    new-instance v6, Lio/reactivex/schedulers/TestScheduler$TimedRunnable;

    const-wide/16 v1, 0x0

    iget-object v7, p0, Lio/reactivex/schedulers/TestScheduler$TestWorker;->b:Lio/reactivex/schedulers/TestScheduler;

    iget-wide v4, v7, Lio/reactivex/schedulers/TestScheduler;->d:J

    const-wide/16 v8, 0x1

    add-long/2addr v8, v4

    iput-wide v8, v7, Lio/reactivex/schedulers/TestScheduler;->d:J

    move-object v0, v6

    move-object v3, p1

    invoke-direct/range {v0 .. v5}, Lio/reactivex/schedulers/TestScheduler$TimedRunnable;-><init>(JLjava/lang/Runnable;J)V

    iget-object p1, v7, Lio/reactivex/schedulers/TestScheduler;->c:Ljava/util/concurrent/PriorityBlockingQueue;
    ...
    invoke-direct {p1, p0, v6}, Lio/reactivex/schedulers/TestScheduler$TestWorker$QueueRemove;-><init>(Lio/reactivex/schedulers/TestScheduler$TestWorker;Lio/reactivex/schedulers/TestScheduler$TimedRunnable;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/Disposable;
    ...
    iget-wide v4, p2, Lio/reactivex/schedulers/TestScheduler;->d:J
    ...
    iget-object p1, p2, Lio/reactivex/schedulers/TestScheduler;->c:Ljava/util/concurrent/PriorityBlockingQueue;
