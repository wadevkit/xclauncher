...
.method public static a(ZZLio/reactivex/Observer;Lio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/ObservableQueueDrain;)Z
    ...
    invoke-interface {p5}, Lio/reactivex/internal/util/ObservableQueueDrain;->d()Z
    ...
    invoke-interface {p5}, Lio/reactivex/internal/util/ObservableQueueDrain;->e()Ljava/lang/Throwable;
...
.method public static b(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lio/reactivex/Observer;Lio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/ObservableQueueDrain;)V
    ...
    :cond_0
    invoke-interface {p3}, Lio/reactivex/internal/util/ObservableQueueDrain;->b()Z
    ...
    invoke-interface {p3, v1}, Lio/reactivex/internal/util/ObservableQueueDrain;->a(I)I
    ...
    :cond_4
    invoke-interface {p3, p1, v2}, Lio/reactivex/internal/util/ObservableQueueDrain;->f(Lio/reactivex/Observer;Ljava/lang/Object;)V
...
.method public static c(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lorg/reactivestreams/Subscriber;Lio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
    ...
    :goto_1
    invoke-interface {p3}, Lio/reactivex/internal/util/QueueDrain;->d()Z
    ...
    invoke-interface {p3}, Lio/reactivex/internal/util/QueueDrain;->e()Ljava/lang/Throwable;
    ...
    invoke-interface {p3, v1}, Lio/reactivex/internal/util/QueueDrain;->a(I)I
    ...
    invoke-interface {p3, v3, p1}, Lio/reactivex/internal/util/QueueDrain;->i(Ljava/lang/Object;Lorg/reactivestreams/Subscriber;)Z
    ...
    invoke-interface {p3}, Lio/reactivex/internal/util/QueueDrain;->c()J
