...
.method public static a(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static b(Ljava/lang/Object;)Lio/reactivex/internal/operators/flowable/FlowableJust;
    .locals 1
    .annotation runtime Lio/reactivex/annotations/BackpressureSupport;
...
# virtual methods
.method public final c(Lio/reactivex/Scheduler;)Lio/reactivex/Flowable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn;-><init>(Lio/reactivex/Flowable;Lio/reactivex/Scheduler;I)V
...
.method public final d(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;)Lio/reactivex/internal/subscribers/LambdaSubscriber;
    .locals 2
    .annotation runtime Lio/reactivex/annotations/BackpressureSupport;
    ...
    invoke-direct {v1, p1, p2, v0}, Lio/reactivex/internal/subscribers/LambdaSubscriber;-><init>(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;)V

    invoke-virtual {p0, v1}, Lio/reactivex/Flowable;->f(Lio/reactivex/FlowableSubscriber;)V
...
.method public final e(Lorg/reactivestreams/Subscriber;)V
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/Flowable;->f(Lio/reactivex/FlowableSubscriber;)V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/Flowable;->f(Lio/reactivex/FlowableSubscriber;)V
...
.method public final f(Lio/reactivex/FlowableSubscriber;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lio/reactivex/Flowable;->i(Lorg/reactivestreams/Subscriber;)V
    :try_end_0
...
.method public abstract i(Lorg/reactivestreams/Subscriber;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lorg/reactivestreams/Subscriber<",
